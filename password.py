...
def pass_8():
    ...
    letter_list = []
    try:
        letters = input("1. Should your password contain letter?(ex:y or n):")
        while count <= 8:
            if letters.lower() == 'y':
    ...
    special_lists = []
    try:
        chars = input("3. Should your password contain any special characters?(ex:y or n):")
        while count <= 5:
            if chars.lower() == 'y':
    ...
    print("---------------------------------------")
    print(f"Your 8 digit password is: {password}")
    print("---------------------------------------")
